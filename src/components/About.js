      ...
      <div className="sec-inner">
        ...
        <div className="about-grid">
          ...
          <div>
            ...
            <p className={'rvr d3 ' + on} style={{ color: '#92400e', marginBottom: 24 }}>Passionate about <strong style={{ color: '#431407' }}>AI, Machine Learning, and Data Analysis</strong>. Seeking thesis opportunities.</p>
            <div className="about-cards">
              <div className={'ac rvf d3 ' + on}><div className="ai">🎓</div><div className="al">University</div><div className="av">Metropolitan Univ.</div></div>
